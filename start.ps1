...
python aws-iot-device-sdk-python\samples\basicPubSub\basicPubSub.py -e a26ti12rpkrqbh-ats.iot.ap-northeast-1.amazonaws.com -r root-CA.crt -c aero.cert.pem -k aero.private.key
